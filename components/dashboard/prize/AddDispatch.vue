    ...
    >
      <template #header>
        <div class="flex flex-col items-start justify-center gap-2 px-2">
          <span class="font-bold text-xl whitespace-nowrap">New Dispatch Request</span>
          <small class="font-light whitespace-nowrap"
            >Create a New Dispatch that would be use in the program</small
          >
        </div>
      </template>
      <form
...
const requestModal = computed(() => {
  return mainStore.requestModal;
});
