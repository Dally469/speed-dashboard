  ...
  <div>
    <div class="flex justify-between items-center w-full">
      <Button
        ...
        class="mr-4"
        label="New Driver"
        @click="mainStore.setRequestModal(true)"
      />
    </div>
      ...
      >
        ...
        <div class="pt-4 gap-4 justify-end flex">
          <Button
            ...
            icon="pi pi-remove"
            iconPos="right"
            @click="mainStore.setRequestModal(false)"
          />
    ...
    >
      <template #header>
        <div class="flex flex-col items-start justify-center gap-2 px-2">
          <span class="font-bold text-xl whitespace-nowrap">Update Request</span>
      ...
      >
          ...
          <div class="flex flex-col gap-1">
            <small for="username" class="text-xl pb-4 ">Request Status</small>
            <div class="grid grid-cols-2 gap-2">
              <div v-for="(category, i) in driverStatus" :key="category.id" class="flex  items-center">
                  <RadioButton v-model="formState.status" :inputId="category.key" name="dynamic" :value="category.name" />
    ...
    >
      ...
      <form
        ...
        class="w-full lg:px-4 max-sm:px-2 space-y-2"
      >
       <small class="font-light text-xl text-center "
            >Are you sure you want to delete this <small class="font-bold"> {{request?.client.fname +' '+request?.client.lname}} </small></small
          >
        <div class="pt-4  gap-4 justify-end flex">
          <Button
            severity="danger"
...
function deleteUser() {
  store.deleteReqestById(request.value?.id);
 }
